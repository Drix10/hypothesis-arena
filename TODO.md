...
- [ ] Later: 11. Phase 2.5 research plane (bundle model, sandbox image) → 12. Phase 3 C++ core cont. (P3.1 RE-SIGNED; P3.2 FROZEN; P3.3 ACCEPTED; P3.4=(b); P3.5 PLANNING (slices A–H in doc 13 §13.5, 04→05→06 order; Slice A encapsulation design fixed incl. no-copy-then-mutate refinement; NO CODE until human authorizes each slice)) → 13. Phase 4 paper loop G0 → 14-16. G1/G2/G3 gates. (10. Phase 2 JEV sidecar DONE, accepted/frozen `50ea369` + authorized hardening.)
