...
- [ ] PRE-D GATE (authorized; Slice D stays NOT AUTHORIZED until accepted): [x] Phase A research reconciliation (memos verified against source, no re-research); [x] Phase B contracts (doc 03 case 29 + test row, P3.3 81/81; doc 11 §11.1a regime/decay with H=infinity default; doc 05 §5.1c risk DAG; doc 13 §13.7 battle ladder); [x] Phase C TODO reconciliation (this line); [ ] Phase D TIme: Phase 2.5 research plane (doc 08 §8.6 + doc 09 §9.4 boxes: graph+checkpoints, sandbox, feature writer, resolver, R15/R12/isolation/egress/atomicity proofs, Langfuse attribution, cadence proof, Tier-A readiness, lessons seed); [ ] Phase E dependency audit vs D–H1; then human Slice-D authorization.
...
- [ ] Later: 11. Phase 2.5 research plane (PRE-D GATE Phase D, authorized next) → 12. Phase 3 C++ core cont. (P3.1 RE-SIGNED; P3.2 FROZEN; P3.3 ACCEPTED + case-29 row, 81/81; P3.4=(b); P3.5 slices A–C DONE/CLOSED, D NOT AUTHORIZED) → 13. Phase 4 paper loop G0 → 14-16. G1/G2/G3 gates. (10. Phase 2 JEV sidecar DONE, accepted/frozen `50ea369` + authorized hardening.)
