...
- [ ] NEXT (awaiting human review): research/p15-phase2-readiness.md reconciles plan + P1.1-P1.4 evidence + JS gap analysis. Concrete P1.5/Phase-2 plans with acceptance tests inside. BLOCKED on: (1) human review of readiness memo, (2) OPENROUTER_API_KEY for Phase 2 runtime. No Phase 2 code written.
