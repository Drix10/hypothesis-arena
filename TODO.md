...
- [ ] Later: 11. Phase 2.5 research plane (bundle model, sandbox image) → 12. Phase 3 C++ core cont. (P3.1 RE-SIGNED; P3.2 FROZEN; P3.3 ACCEPTED; P3.4=(b); P3.5 PLANNING (slices A–H1 in doc 13 §13.5, 04→05→06 order; H2 = Phase 4 operational evidence; Slice A encapsulation design fixed incl. no-copy-then-mutate refinement + negative compile tests; gate classes [correctness]/[drill]/[soak]/[operational] with soak never retro-blocking; Slice A AUTHORIZED and DONE (see Slice A line); Slice B NOT AUTHORIZED)) → 13. Phase 4 paper loop G0 → 14-16. G1/G2/G3 gates. (10. Phase 2 JEV sidecar DONE, accepted/frozen `50ea369` + authorized hardening.)
