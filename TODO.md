...
- [ ] PHASE 3 PLANNED: plan/13-cpp-kernel-build.md (P3.1 boundary validator first, P3.2 canonical vector, P3.3 typed table, P3.4 confidence, P3.5 risk/sizing/exec). Awaiting human build order.
