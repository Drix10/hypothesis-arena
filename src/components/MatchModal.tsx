...
const MatchModal: React.FC<MatchModalProps> = ({ match, agents, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-slate-950 border border-slate-700 w-full max-w-5xl max-h-[90vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col ring-1 ring-white/10 animate-in zoom-in-95 duration-300 slide-in-from-bottom-4"
      ...
      >
        ...
        <div className="overflow-y-auto flex-1 p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 custom-scrollbar">
            ...
            {match.fatalFlaw && (
              <div className="bg-red-950/10 rounded-2xl p-6 border border-red-900/20">
                <h3 className="text-xs font-mono text-red-400 mb-2 flex items-center gap-2 uppercase tracking-widest">
                  <AlertTriangle className="w-4 h-4" /> Identified Vulnerability
                </h3>
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col">
            ...
            {/* Scores */}
            {match.scores && (
              <div className="bg-slate-900/80 rounded-2xl p-6 border border-slate-800 flex-1 flex flex-col">
                <h3 className="text-xs font-mono text-slate-500 mb-4 uppercase tracking-widest text-center">
                  Performance Metrics
                </h3>
