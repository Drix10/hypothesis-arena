...
router.post('/debate', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
router.post('/signal', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { symbol } = req.body;
...
router.post('/tournament', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { symbol } = req.body;
...
router.post('/trading-decision', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
router.post('/extended', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { symbol, analystId } = req.body;
