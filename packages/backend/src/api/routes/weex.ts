...
router.get('/position/:symbol', authenticate, async (req: Request, res: Response, next: NextFunction) => {
    try {
        const symbol = req.params.symbol.toLowerCase();
...
router.get('/orders/history/:symbol', authenticate, async (req: Request, res: Response, next: NextFunction) => {
    try {
        const symbol = req.params.symbol.toLowerCase();
...
router.get('/fills/:symbol', authenticate, async (req: Request, res: Response, next: NextFunction) => {
    try {
        const symbol = req.params.symbol.toLowerCase();
...
router.post('/leverage', authenticate, async (req: Request, res: Response, next: NextFunction) => {
    try {
